...
INSERT INTO `migration` VALUES ('m000000_000000_base',1496839221),('m130524_201442_init',1496839227);
...
CREATE TABLE `user` (
  ...
  UNIQUE KEY `idx_id_curso` (`id_curso`) USING BTREE,
...
-- Dump completed on 2017-06-07  9:07:12
